...
describe('String Validation Functions', () => {
  ...
  function testValidCases(schema: any, validCases: any[]) {
  ...
  function testInvalidCases(schema: any, invalidCases: any[]) {
  ...
  describe('datetime validation', () => {
    ...
    describe('with offset option', () => {
      const offsetSchema = string().datetime({ offset: true });
    ...
    describe('with local option', () => {
      const localSchema = string().datetime({ local: true });
    ...
    describe('with precision option', () => {
      const precisionSchema = string().datetime({ precision: 3 });
  ...
  describe('CIDR validation', () => {
    ...
    describe('with version option', () => {
      const ipv4CidrSchema = string().cidr({ version: 'v4' });
      ...
      const ipv6CidrSchema = string().cidr({ version: 'v6' });
  ...
  describe('time validation', () => {
    ...
    describe('with precision option', () => {
      const precisionTimeSchema = string().time({ precision: 3 });
  ...
  describe('IP address validation', () => {
    ...
    describe('with version option', () => {
      const ipv4Schema = string().ip({ version: 'v4' });
      ...
      const ipv6Schema = string().ip({ version: 'v6' });
  ...
  describe('performance', () => {
    test('handles large strings efficiently', () => {
      ...
      const schema = string().maxLength(20000);
